...
class CUTModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--decay_D', type=float, default=1.0, help='decay learning rate for Discriminator')
    ...
    def compute_D_loss(self):
        ...
        self.loss_D = (self.loss_D_fake + self.loss_D_real) * 0.5 * self.opt.decay_D
        return self.loss_D
