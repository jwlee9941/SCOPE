...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--no_html', action='store_true', help='do not save intermediate training results to [opt.checkpoints_dir]/[opt.model_name]/web/')
        ...
        # nii specific
        parser.add_argument('--input_nii_filename_A', type=str, default='r_FBB_coreg.nii', help='filename for the input NII image for domain A (e.g., Low Dose CT)')
        parser.add_argument('--input_nii_filename_B', type=str, default='_FBB_golden.nii', help='filename for the target NII image for domain B (e.g., High Dose CT)')
