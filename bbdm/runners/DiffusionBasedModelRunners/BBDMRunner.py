...
class BBDMRunner(DiffusionBaseRunner):
    ...
    def sample_to_eval(self, net, test_dataset, sample_path):
        ...
        raw_data_dir = "/root/ADNI_FBB_coreg2/ADNI_FBB_coreg2"
        if 'BraTS' in sample_path:
            raw_data_dir = "/root/BraTS/ASNR-MICCAI-BraTS2023-GLI-Challenge-ValidationData"
        ...
        results_file = os.path.join('/root/CT2MRI/results/test_results.csv')
